import { Heart, Moon, Sun, Settings, MessageCircle, Search, User, Sparkles } from "lucide-react";
      ...
      <div className="container flex h-16 items-center px-4 md:px-8">
        <div className="mr-4 hidden md:flex">
          ...
          >
            ...
            <span className="font-display text-lg font-semibold tracking-tight">Elysian</span>
          </button>
        </div>
